class ImdbController < ApplicationController
  ...
  def result
    ...
    @book_rating = 4.5
    @book_description='this is the description of the book,in this book you will learn how to use
    java and java script to design web. Java language redirects here. For the natural language from the Indonesian island of Java, see Javanese language.
